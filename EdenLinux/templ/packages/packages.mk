...
${local}BUILD := $(TOOLCHAIN_INSTALL) $(PACKAGES_BUILD_DIR) $(PACKAGES_KERNEL_BUILD) $(PACKAGES_BUSYBOX_ALL) $(PACKAGES_E2FSPROGS_ALL) $(PACKAGES_IANA-ETC_ALL) $(PACKAGES_ZLIB_ALL) $(PACKAGES_NCURSES_ALL) $(PACKAGES_NANO_ALL) $(PACKAGES_DROPBEAR_ALL) $(PACKAGES_UDEV_ALL) $(PACKAGES_PYTHON_ALL)

${local}INSTALL := $(PACKAGES_KERNEL_INSTALL) $(PACKAGES_BUSYBOX_INSTALL) $(PACKAGES_E2FSPROGS_INSTALL) $(PACKAGES_E2FSPROGS_INSTALL-LIBS) $(PACKAGES_IANA-ETC_INSTALL) $(PACKAGES_ZLIB_INSTALL) $(PACKAGES_NCURSES_INSTALL) $(PACKAGES_NANO_INSTALL) $(PACKAGES_BOOTDEVS_INSTALL) $(PACKAGES_BASECONF_INSTALL) $(PACKAGES_DROPBEAR_INSTALL) $(PACKAGES_UDEV_DEVICES) $(PACKAGES_UDEV_INSTALL) $(PACKAGES_PYTHON_INSTALL)