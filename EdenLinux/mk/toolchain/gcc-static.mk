...
${package("$(TOOLCHAIN_BUILD_DIR)/gcc-$(TOOLCHAIN_GCC-STATIC_VERSION)", "$(TOOLCHAIN_BUILD_DIR)/gcc-static", "4.4.5", "gcc-$(TOOLCHAIN_GCC-CROSS_VERSION).tar.bz2", "ftp://gcc.gnu.org/pub/gcc/releases/gcc-$(TOOLCHAIN_GCC-STATIC_VERSION)/$(TOOLCHAIN_GCC-STATIC_FILE)")}
...
${make('CFLAGS="" CXXFLAGS=""', "", "install", "$(TOOLCHAIN_ROOT_DIR)/bin/$(ARCH_TARGET)-gcc", "$(TOOLCHAIN_GCC-STATIC_ALL)")}
