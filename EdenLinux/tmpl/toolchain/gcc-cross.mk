...
${py gcc_cross = Package("$(TOOLCHAIN_BUILD_DIR)/gcc-$(TOOLCHAIN_GCC-CROSS_VERSION)", "$(TOOLCHAIN_BUILD_DIR)/gcc-cross", "4.6.2", "ftp://gcc.gnu.org/pub/gcc/releases/gcc-$(TOOLCHAIN_GCC-CROSS_VERSION)/gcc-$(TOOLCHAIN_GCC-CROSS_VERSION).tar.bz2", "$(TOOLCHAIN_ROOT_DIR)/bin/$(ARCH_TARGET)-c++")}
${gcc_cross}
