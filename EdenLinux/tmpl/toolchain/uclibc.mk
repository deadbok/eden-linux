...
${MakeRule('CFLAGS="" CXXFLAGS="" PATH=$(GCC-STATIC_PATH)', '-j1 CROSS=$(ARCH_TARGET)- CC="$(ARCH_TARGET)-gcc" KERNEL_HEADERS=$(ROOTFS_DIR)/usr/include PREFIX="$(TOOLCHAIN_ROOT_DIR)/uclibc"', "$(TOOLCHAIN_UCLIBC_BUILD_DIR)", "install", "$(TOOLCHAIN_ROOT_DIR)/uclibc/lib/libc.so.0", "$(TOOLCHAIN_UCLIBC_BUILD)", "TOOLCHAIN_UCLIBC_LOCAL-INSTALL")}
