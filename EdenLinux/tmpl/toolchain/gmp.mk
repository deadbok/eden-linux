...
${py gmp = AutoconfPackage('$(TOOLCHAIN_BUILD_DIR)/gmp-$(TOOLCHAIN_GMP_VERSION)', '', '5.1.3', "ftp://ftp.gnu.org/pub/pub/gnu/gmp/gmp-$(TOOLCHAIN_GMP_VERSION).tar.bz2", "$(TOOLCHAIN_ROOT_DIR)/lib/libgmp.la")}
${gmp}
