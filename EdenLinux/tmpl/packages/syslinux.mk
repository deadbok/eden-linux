...
${py syslinux = Package("$(PACKAGES_BUILD_DIR)/syslinux-$(PACKAGES_SYSLINUX_VERSION)", "", "4.02", "http://launchpad.net/syslinux/main/$(TOOLCHAIN_SYSLINUX_VERSION)/+download/syslinux-$(TOOLCHAIN_SYSLINUX_VERSION).tar.gz", "$(ROOTFS_DIR)/boot/extlinux.conf")}
${syslinux}
