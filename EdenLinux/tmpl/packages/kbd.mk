...
${AutoconfPackage('$(PACKAGES_BUILD_DIR)/kbd-$(PACKAGES_KBD_VERSION)', '', '1.14.1', "http://www.kbd-project.org/download/kbd-$(PACKAGES_KBD_VERSION).tar.bz2", "$(ROOTFS_DIR)/usr/bin/mke2fs")}
